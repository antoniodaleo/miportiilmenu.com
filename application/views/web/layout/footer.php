    ...
    <footer>
							...
							<div class="footer-wrapper mb-30">
								...
								<div class="footer-text">
									<p>www.miportiilmenu.com é un gruppo di programmatori Free lancer, cui l'obiettivo
										principale é aiutare i piccoli negozi ad avere un proprio spazio sul web. 
									    Con noi non servono grandi capitali e ne competenze informatiche per iniziare ad 
										investire su internet. Noi ti offriamo dei template moderni, che si adattano ai cellulari 
									    e ai tablet, ti offriamo la nostra assistenza tecnica h24 e un contatto per telefono. </p>
								</div>
						...
						<div class="col-xl-3 col-lg-3 col-md-6">
							<div class="footer-wrapper mb-30">
								...
								<ul class="footer-menu">
									<li><a href="#"><i class="fas fa-caret-right"></i>Chi siamo</a></li>
									<li><a href="#"><i class="fas fa-caret-right"></i>Nostri servizi</a></li>
									<li><a href="#"><i class="fas fa-caret-right"></i>Entra in contatto</a></li>
									<li><a href="#"><i class="fas fa-caret-right"></i>Notizie</a></li>
								</ul>
							</div>
						</div>
						<div class="col-xl-3 col-lg-3 col-md-6">
							<div class="footer-wrapper mb-30">
								...
								<ul class="footer-img">
									<li><a href="#"><img alt="" src="public/web/img/instagram/1.jpg"></a></li>
									<li><a href="#"><img alt="" src="public/web/img/instagram/2.jpg"></a></li>
									<li><a href="#"><img alt="" src="public/web/img/instagram/3.jpg"></a></li>
									<li><a href="#"><img alt="" src="public/web/img/instagram/4.jpg"></a></li>
									<li><a href="#"><img alt="" src="public/web/img/instagram/5.jpg"></a></li>
									<li><a href="#"><img alt="" src="public/web/img/instagram/6.jpg"></a></li>
								</ul>
							</div>
						</div>
						<div class="col-xl-3 col-lg-3 col-md-6">
							<div class="footer-wrapper mb-30">
								...
								<ul class="footer-link">
									...
									<li><i class="far fa-envelope"></i>antoniodaleo</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="copyright text-center">
							<p><a target="_blank" href="https://agenciatwincode.com.br">Agenzia TwinCode</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- JS here -->
        <script src="<?php echo base_url('public/web/js/vendor/modernizr-3.5.0.min.js'); ?>"></script>
        ...
        <script src="<?php echo base_url('public/web/js/ajax-form.js'); ?>"></script>
        <script src="<?php echo base_url('public/web/js/wow.min.js'); ?>"></script>
        <script src="<?php echo base_url('public/web/js/jquery.scrollUp.min.js'); ?>"></script>
        ...
        <script src="<?php echo base_url('public/web/js/plugins.js'); ?>"></script>
